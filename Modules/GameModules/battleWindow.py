...
class TypeingGame:
    ...
    def display(self, screen:pygame.Surface):
        w, h = screen.get_size()
        pygame.draw.rect(screen, (50, 100, 50), pygame.Rect(60, 20, w-110, h-300), 1)
        pygame.draw.rect(screen, (255, 255, 255), pygame.Rect(100, 50, 600, 200), 4)
        font = pygame.font.Font(
        'font_data/PixelMplus-20130602/PixelMplus12-Regular.ttf', 40)
        font.set_bold(True)
        ...
        #self.answer = self.return_ans(self.index)
        font = pygame.font.Font(
        'font_data/PixelMplus-20130602/PixelMplus12-Regular.ttf', 30)
